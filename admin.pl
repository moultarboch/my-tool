...
print "
        ...
        |                        STAY LEGAL !!                           | 
        |                    .:.:. Contact .:.:.                         | 
        |  Github  :     https://github.com/3oraqi                       | 
        |  Website :            www.1m5t.xyz                             | 
        |  instagram :   :  www.instagram.com/moul_tarboch/              |         
        ╘────────────────────────────────────────────────────────────────╝  
";
print " Please Add Website الهدف :) :) :) \n Example: www.moultarboch.com \n-> ";
$address=<STDIN>;
chomp $address;
...
print " \n #hello his's hire: [+] Ow ! Found => $findall\n\n";
}else{
print "#wassim find:[-] Not Found <- $findall\n";
}
}
}
...
print "
         ...
         |                    .:.:. Contact .:.:.                         | 
         |  Github  :     https://github.com/3oraqi                       | 
         |  Website :        3oraqi.webs.com/                             | 
         |  insta   :  https://www.instagram.com/moul_tarboch/            |         
         ╘────────────────────────────────────────────────────────────────╝ 
